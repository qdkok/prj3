...
public class CouponVO {
	...
	public CouponVO(String c_no, String c_image, String c_name, String c_info, String a_id, int start_year,
			int start_month, int start_day, int end_year, int end_month, int end_day, int discount) {
		this.c_no = c_no;
