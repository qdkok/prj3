...
public class UtilizeVO {
	private String t_no,u_name,sale_flag,info,u_image,a_id;
	private int price,start_year,start_month,start_day,end_year,end_month,end_day;

	public UtilizeVO() {
	}

	public UtilizeVO(String t_no, String u_name, String sale_flag, String info, String u_image, String a_id, int price,
