...
public class EventVO {
	...
	public EventVO(String e_no, String e_name, String e_info, String r_position, String r_image, String r_file,
			String a_id, int start_year, int start_month, int start_day, int end_year, int end_month, int end_day) {
		this.e_no = e_no;
		this.e_name = e_name;
		this.e_info = e_info;
	...
	public String toString() {
		return "EventVO [e_no=" + e_no + ", e_name=" + e_name + ", e_info=" + e_info + ", r_position=" + r_position
