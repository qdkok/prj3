				...
				<div id="navi_bar" >
				    <nav id="main-nav">
						   ...
						   <ul id="main-menu" class="sm sm-simple">
						        <li class="hongki"><a href="land_intro.do" style="font-size: 20px; margin-top: 25px">HK랜드</a>
						        	<ul>
						        		<li><a href="land_intro.do">HK랜드 소개</a></li>
						        		<li><a href="land_roller.do">놀이기구 안내</a></li>
						        		<li><a href="land_info.do">랜드 정보</a></li>
						        	</ul>
						        </li>
						        ...
						        <li class="hongki" ><a href="#void" style="font-size: 20px; margin-top: 25px">고객서비스</a>
						        	<ul>
						        		<li><a href="#void" >공지사항</a>
						        		<li><a href="#void" >문의사항</a>
						        		<li><a href="#void" >분실물센터</a>
						        	</ul>
						        </li>
						  </ul>
					</nav>
