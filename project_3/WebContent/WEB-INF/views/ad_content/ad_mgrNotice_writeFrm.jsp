			...
			<div id="r_content">
				...
				<div id="r_content_view">
					<div id="mainContent">
						...
						<form method="get" name="frm" action="mgrNotice_writeFrm.do?cmd=w" id="noteFrm">
						<input type="hidden" name="cmd" value="w">
						<input type="hidden" name="a_id" value="${ sessionScope.a_id }">
						<%-- 
						<input type="hidden" name="n_inputdate" value="공지사항6"> --%>
						<table id="writeTable">
							<tr>
								<td>작성자</td>
								<td>${ sessionScope.a_id }( ${ sessionScope.a_name } )</td>
							</tr>
							<tr>
								<td>제목</td>
								<td><input type="text" name="n_name" class="inputBox"></td>
							</tr>
							<tr>
								<td colspan="2">글내용 작성</td>
							</tr>
						</table>
							<textarea id="summernote" name="n_info"></textarea>
							<div id="btnBox1">
								...
								<input type="button" value="글쓰기" class="btn" id="writeBtn">
							</div>
						</form>
					</div>
				</div>
